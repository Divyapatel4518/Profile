...
const skillCategories = [
  { name: "Methodologies", items: ["BPMN", "UML", "Agile", "Scrum", "Waterfall"] },
  { name: "Analytics & Tools", items: ["Power BI", "Tableau", "Excel", "JIRA", "Confluence"] },
  { name: "Development", items: ["HTML/CSS", "JavaScript", "SQL", "Java", "Python"] }
];
