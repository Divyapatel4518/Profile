  ...
  const educationList = [
    {
      ...
      subjects: "Business Process Modelling (BPMN), Database Management, IT Project Management, Systems Analysis and Design, Programming Fundamentals",
    },
    {
      ...
      subjects: "C, C++, JAVA, PHP, .NET, SQL, IT Professionals, IT Projects",
    }
  ];
